...
describe("line", function()
  it("simple", function()
    local err, fname, hash = parser.line("README.md\t#deadbeef")
    assert.is_nil(err)
  ...
  it("spaces", function()
    local err, fname, hash = parser.line([[ a b c 	#01234567]])
    assert.is_nil(err)
  ...
  it("escaped tab", function()
    local err, fname, hash = parser.line([[before\tafter	#01234567]])
    assert.is_nil(err)
  ...
  it("unescaped tab", function()
    local err, fname, hash = parser.line([[foo	bar	#01234567]])
  ...
  it("invalid escape sequence", function()
    local err, fname, hash = parser.line([[\a  #01234567]])
    assert.is_not_nil(err)
    assert.is_nil(fname)
    assert.is_nil(hash)
  end)
  ...
  it("only hash", function()
    local err, fname, hash = parser.line([[#01234567]])
    assert.is_nil(err)
  ...
  it("short hash", function()
    local err, fname, hash = parser.line([[foo	#0123456]])
    assert.is_not_nil(err)
    assert.is_nil(fname)
    assert.is_nil(hash)
  end)
  ...
  it("long hash", function()
    local err, fname, hash = parser.line([[foo	#012345678]])
    assert.is_not_nil(err)
    assert.is_nil(fname)
    assert.is_nil(hash)
  end)
  ...
  it("invalid hex character hash", function()
    local err, fname, hash = parser.line([[foo	#0123456z]])
    assert.is_not_nil(err)
    assert.is_nil(fname)
    assert.is_nil(hash)
  end)
  ...
  it("trailing spaces after hash", function()
    local err, fname, hash = parser.line([[foo	#01234567  ]])
    assert.is_nil(err)
  ...
  it("trailing spaces no hash", function()
    local err, fname, hash = parser.line([[foo  ]])
    assert.is_nil(err)
    assert.equal(fname, [[foo  ]])
    assert.is_nil(hash)
  end)
  ...
  it("non-ASCII fname", function()
    local err, fname, hash = parser.line([[文档	#01234567]])
    assert.is_nil(err)
